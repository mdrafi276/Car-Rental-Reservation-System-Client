...
const BottomFooter = () => {
    return (
        <div className="flex flex-col lg:flex-row py-5 lg:py-1 bg-[#000000] h-full w-full lg:h-[100px] justify-between md:px-10 items-center">
            <div>
                <h1 className='text-[14px] lg:text-[15px] text-center  text-white '>Copyright © 2024 Carx All Rights Reserved.
                </h1>
            </div>
